...
const ThemeDemo = () => {
  ...
  return (
    <Container maxWidth="lg" sx={{ py: 5 }}>
      <Typography variant="h2" gutterBottom>MUI 主题样式指南</Typography>
      ...
      <Paper sx={{ p: 3, mb: 5 }}>
        ...
        <Typography variant="body1" sx={{ mb: 3 }}>
          <strong>规范1: 优先使用styled API，尽量避免使用sx属性</strong><br/>
          sx属性虽然方便快捷，但会导致样式分散在各处，难以维护。而styled API创建的组件可重用，且样式集中易于管理。
        </Typography>
        
        <Stack direction="row" spacing={2} sx={{ mb: 3 }}>
          <StyledButton variant="contained" color="primary">推荐: Styled组件</StyledButton>
          <Button 
            variant="contained" 
            color="secondary" 
            sx={{ 
...
<Button sx={{ borderRadius: 8, textTransform: 'none', fontWeight: 600 }}>
  按钮
      ...
      <Paper sx={{ p: 3, mb: 5 }}>
        ...
        <Typography variant="h4" gutterBottom>全部Typography变体</Typography>
        <Grid container spacing={2}>
          <Grid size={12}>
            <ColorCard>
              <Typography variant="h1" gutterBottom>H1: 标题一 ({theme.typography.h1.fontSize} / {theme.typography.h1.fontWeight})</Typography>
              <CodeBlock>{`<Typography variant="h1">标题一</Typography>`}</CodeBlock>
            </ColorCard>
            
            <ColorCard>
              <Typography variant="h2" gutterBottom>H2: 标题二 ({theme.typography.h2.fontSize} / {theme.typography.h2.fontWeight})</Typography>
              <CodeBlock>{`<Typography variant="h2">标题二</Typography>`}</CodeBlock>
            </ColorCard>
            
            <ColorCard>
              <Typography variant="h3" gutterBottom>H3: 标题三 ({theme.typography.h3.fontSize} / {theme.typography.h3.fontWeight})</Typography>
              <CodeBlock>{`<Typography variant="h3">标题三</Typography>`}</CodeBlock>
            </ColorCard>
            
            <ColorCard>
              <Typography variant="h4" gutterBottom>H4: 标题四 ({theme.typography.h4.fontSize} / {theme.typography.h4.fontWeight})</Typography>
              <CodeBlock>{`<Typography variant="h4">标题四</Typography>`}</CodeBlock>
            </ColorCard>
            
            <ColorCard>
              <Typography variant="h5" gutterBottom>H5: 标题五 ({theme.typography.h5.fontSize} / {theme.typography.h5.fontWeight})</Typography>
              <CodeBlock>{`<Typography variant="h5">标题五</Typography>`}</CodeBlock>
            </ColorCard>
            
            <ColorCard>
              <Typography variant="subtitle1" gutterBottom>Subtitle1: 副标题一 ({theme.typography.subtitle1.fontSize} / {theme.typography.subtitle1.fontWeight})</Typography>
              <CodeBlock>{`<Typography variant="subtitle1">副标题一</Typography>`}</CodeBlock>
            </ColorCard>
            
            <ColorCard>
              <Typography variant="subtitle2" gutterBottom>Subtitle2: 副标题二 ({theme.typography.subtitle2.fontSize} / {theme.typography.subtitle2.fontWeight})</Typography>
              <CodeBlock>{`<Typography variant="subtitle2">副标题二</Typography>`}</CodeBlock>
            </ColorCard>
            
            <ColorCard>
              <Typography variant="body1" gutterBottom>Body1: 正文一 ({theme.typography.body1.fontSize} / {theme.typography.body1.fontWeight})</Typography>
              <CodeBlock>{`<Typography variant="body1">正文一</Typography>`}</CodeBlock>
            </ColorCard>
            
            <ColorCard>
              <Typography variant="body2" gutterBottom>Body2: 正文二 ({theme.typography.body2.fontSize} / {theme.typography.body2.fontWeight})</Typography>
              <CodeBlock>{`<Typography variant="body2">正文二</Typography>`}</CodeBlock>
            </ColorCard>
          </Grid>
        </Grid>

        <Typography variant="h4" sx={{ mt: 4 }} gutterBottom>如何添加特殊样式</Typography>
        <ColorCard>
...
>
  带颜色和加粗的H3标题
        ...
        <Typography variant="h4" sx={{ mt: 4 }} gutterBottom>使用styled API定制Typography</Typography>
        <ColorCard>
...
<SectionTitle variant="h3">自定义样式标题</SectionTitle>`}</CodeBlock>
      ...
      <Paper sx={{ p: 3, mb: 5 }}>
        ...
        <Typography variant="h4" gutterBottom>主题颜色及其变体</Typography>
        <Grid container spacing={3}>
          <Grid size={12}>
            {/* Primary颜色 */}
            <ColorCard>
              <Typography variant="h5" gutterBottom>Primary 主色</Typography>
...
theme.palette.primary.dark   // 深色变体`}</CodeBlock>
            ...
            {/* Secondary颜色 */}
            <ColorCard>
              <Typography variant="h5" gutterBottom>Secondary 次要色</Typography>
              <Stack direction="row" spacing={2} flexWrap="wrap" useFlexGap>
            ...
            {/* 语义颜色 */}
            <Typography variant="h5" sx={{ mt: 4 }} gutterBottom>语义颜色</Typography>
            <Grid container spacing={2}>
              <Grid size={6}>
                <ColorCard>
                  <Typography variant="subtitle1" gutterBottom>Error 错误色</Typography>
                  <Stack direction="row" spacing={2} flexWrap="wrap" useFlexGap>
              ...
              <Grid size={6}>
                <ColorCard>
                  <Typography variant="subtitle1" gutterBottom>Warning 警告色</Typography>
                  <Stack direction="row" spacing={2} flexWrap="wrap" useFlexGap>
              ...
              <Grid size={6}>
                <ColorCard>
                  <Typography variant="subtitle1" gutterBottom>Info 信息色</Typography>
                  <Stack direction="row" spacing={2} flexWrap="wrap" useFlexGap>
              ...
              <Grid size={6}>
                <ColorCard>
                  <Typography variant="subtitle1" gutterBottom>Success 成功色</Typography>
                  <Stack direction="row" spacing={2} flexWrap="wrap" useFlexGap>
            ...
            <Typography variant="h4" sx={{ mt: 4 }} gutterBottom>在组件中使用颜色</Typography>
...
>
  彩色文本
      ...
      <Paper sx={{ p: 3, mb: 5 }}>
        ...
        <Typography variant="body1" sx={{ mb: 3 }}>
          我们的间距系统基于<strong>4px</strong>作为基本单位。使用spacing函数可以获得一致的间距值。
        </Typography>
        
        <Grid container spacing={2}>
          <Grid size={12}>
            <ColorCard>
              <Typography variant="h5" gutterBottom>间距单位换算</Typography>
            ...
            <Typography variant="h4" sx={{ mt: 4 }} gutterBottom>间距演示</Typography>
            ...
            <Typography variant="h4" sx={{ mt: 4 }} gutterBottom>在styled API中使用间距</Typography>
  ...
  padding: theme.spacing(2, 3, 2, 3), // 上下8px, 左右12px
            ...
            <Typography variant="h5" sx={{ mt: 3 }} gutterBottom>应用场景示例</Typography>
            <Grid container spacing={2}>
              <Grid size={6}>
              ...
              <Grid size={6}>
                <ColorCard>
                  <Typography variant="subtitle2" gutterBottom>常用间距场景</Typography>
      ...
      <Paper sx={{ p: 3, mb: 5 }}>
        ...
        <Typography variant="h4" gutterBottom>阴影级别演示</Typography>
        ...
        <Typography variant="h4" gutterBottom>如何使用阴影</Typography>
...
<Box sx={{ boxShadow: 3 }}>阴影级别3</Box>`}</CodeBlock>
        ...
        <Typography variant="h4" sx={{ mt: 4 }} gutterBottom>阴影使用场景</Typography>
        <ColorCard>
          <Typography variant="body1" component="div">
            <ul>
              <li><strong>elevation 0-1:</strong> 平面元素，卡片分隔</li>
              <li><strong>elevation 2-4:</strong> 悬浮元素，按钮，下拉菜单</li>
              <li><strong>elevation 6-8:</strong> 对话框，弹出窗口</li>
              <li><strong>elevation 12-16:</strong> 抽屉，侧边栏</li>
              <li><strong>elevation 24:</strong> 模态框，最高层级元素</li>
            </ul>
          </Typography>
        </ColorCard>
      </Paper>
      ...
      <Paper sx={{ p: 3, mb: 5 }}>
        ...
        <Typography variant="h4" gutterBottom>Z-Index预设值</Typography>
        <ColorCard>
          <Grid container spacing={2}>
            <Grid size={{ xs: 12, sm: 6 }}>
              <Typography variant="body1" component="div">
                <ul>
                  <li><strong>mobileStepper:</strong> {theme.zIndex.mobileStepper}</li>
                  <li><strong>speedDial:</strong> {theme.zIndex.speedDial}</li>
                  <li><strong>appBar:</strong> {theme.zIndex.appBar}</li>
                </ul>
              </Typography>
            </Grid>
            <Grid size={{ xs: 12, sm: 6 }}>
              <Typography variant="body1" component="div">
                <ul>
                  <li><strong>drawer:</strong> {theme.zIndex.drawer}</li>
                  <li><strong>modal:</strong> {theme.zIndex.modal}</li>
                  <li><strong>snackbar:</strong> {theme.zIndex.snackbar}</li>
                  <li><strong>tooltip:</strong> {theme.zIndex.tooltip}</li>
                </ul>
              </Typography>
            </Grid>
          </Grid>
        ...
        <Typography variant="h4" sx={{ mt: 4 }} gutterBottom>在组件中使用Z-Index</Typography>
...
const CustomOverlay = styled(Box)(({ theme }) => ({
  ...
  zIndex: theme.zIndex.modal - 1, // 在modal下方但在其他元素上方
        ...
        <Typography variant="h5" sx={{ mt: 3 }} gutterBottom>层级使用规范</Typography>
      ...
      <Paper sx={{ p: 3 }}>
        ...
        <Typography variant="h4" gutterBottom>断点值</Typography>
        <ColorCard>
          <Grid container spacing={2}>
            <Grid size={{ xs: 12, sm: 6 }}>
              <Typography variant="body1" component="div">
                <ul>
                  <li><strong>xs:</strong> 0px 起始</li>
                  <li><strong>sm:</strong> 600px 起始</li>
                  <li><strong>md:</strong> 900px 起始</li>
                </ul>
              </Typography>
            </Grid>
            <Grid size={{ xs: 12, sm: 6 }}>
              <Typography variant="body1" component="div">
                <ul>
                  <li><strong>lg:</strong> 1200px 起始</li>
                  <li><strong>xl:</strong> 1536px 起始</li>
                </ul>
              </Typography>
            </Grid>
          </Grid>
        ...
        <Typography variant="h4" sx={{ mt: 4 }} gutterBottom>使用断点的方式</Typography>
        
        <Typography variant="h5" gutterBottom>1. 在Grid组件中</Typography>
  ...
  <Grid size={{ xs: 12, sm: 6, md: 4 }}>
    ...
    <Box>内容</Box>
        ...
        <Typography variant="h5" sx={{ mt: 3 }} gutterBottom>2. 在styled API中使用媒体查询</Typography>
  ...
  [theme.breakpoints.between('xs', 'md')]: {
    margin: theme.spacing(1),
        ...
        <Typography variant="h5" sx={{ mt: 3 }} gutterBottom>3. 断点辅助函数</Typography>
        <ColorCard>
          <Typography variant="body1" component="div">
            <ul>
              <li><strong>up(breakpoint)</strong> - 大于等于断点时应用</li>
              <li><strong>down(breakpoint)</strong> - 小于断点时应用</li>
              <li><strong>only(breakpoint)</strong> - 仅在特定断点范围内应用</li>
              <li><strong>between(start, end)</strong> - 在指定断点范围内应用</li>
            </ul>
          </Typography>
        </ColorCard>

        <Typography variant="h4" sx={{ mt: 4 }} gutterBottom>响应式设计最佳实践</Typography>
        <Typography variant="body1" paragraph>
          1. 使用<strong>移动优先</strong>的设计方法，先为最小屏幕设计，再逐步适配更大屏幕
        </Typography>
        <Typography variant="body1" paragraph>
          2. <strong>优先使用Flex布局</strong>实现响应式设计，它比Grid更灵活，性能更好，易于维护
        </Typography>
        <Typography variant="body1" paragraph>
          3. 对于复杂的响应式行为，可以使用useMediaQuery Hook来根据屏幕尺寸条件渲染内容
        </Typography>
        
        <Typography variant="h5" sx={{ mt: 3 }} gutterBottom>Flex布局示例</Typography>
...
<ResponsiveContainer>
  ...
  <Paper>项目3</Paper>
        ...
        <Typography variant="h5" sx={{ mt: 3 }} gutterBottom>结合Stack组件使用Flex</Typography>
        <Typography variant="body1" paragraph>
